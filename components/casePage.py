    ...
    def __init__(self, case: Case) -> None:
        ...
        with self.questionsTab:
            ...
            with self.imagesTab:
                ...
                with col1:
                    st.image("C:/Users/Jerry H/Desktop/chatbot-app/data/cases/images/cxr-ett-normal.jpg", caption="Normal ETT")
                with col2:
                    st.image("C:/Users/Jerry H/Desktop/chatbot-app/data/cases/images/rmb.Seq1.Ser1.Img1.jpg",
